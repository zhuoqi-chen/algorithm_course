...
console.log(linkedListR5.getStatus());
console.log("test revers2");
const linkedListR6 = new LinkedListR();
linkedListR6.addLast(1);
linkedListR6.addLast(2);
linkedListR6.addLast(3);
console.log(linkedListR6.getStatus());
linkedListR6.reverseRecursion();
console.log(linkedListR6.getStatus());
